...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        com.online.seva.domain.User userData = jpaUserRepository.findByUsername(username);
        if (userData == null)
    ...
    private List<GrantedAuthority> buildUserAuthority(com.online.seva.domain.User user) {
...
/*
        for (Role role : userRoleRepository.findAll()) {
            if (role.getUsers() != null) {
                ...
                for (com.online.seva.domain.User userFromrole : role.getUsers()) {
...
*/
    ...
    private User buildUserForAuthentication(com.online.seva.domain.User user, List<GrantedAuthority> authorities) {
